 ...
 */
package org.openmrs.module.savicspharmacy.api.dao;
...
@Transactional
public interface PharmacyDao<T extends Serializable> {
	...
	@Transactional(readOnly = true)
	List getListByAttributes(Class<T> t, String[] ids, Object[] values) throws APIException;
	
	@Transactional(readOnly = true)
	List getListByAttributes(Class<T> t, String[] ids, Object[] values, String[] notNullIds) throws APIException;
